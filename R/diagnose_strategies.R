...
diagnose_strategies <- function(reference_model,
	...
	if(!is.null(possible_data)){
		...
		if(length(conditions) == 1){
			return_list <- diagnose_strategies(reference_model, analysis_model, given, queries, estimates_database, possible_data, possible_data_args = list(N = N, within = within,vars = vars, condition = conditions), sims = sims)
		} else{
			## option 1
