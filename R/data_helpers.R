...
#'
#' @param model A model object generated by \code{make_model()}.
#' @param complete_data Logical. If TRUE return only complete data types (no NAs)
#' @param possible_data Logical. If TRUE returns only complete data types (no NAs) that are *possible* given model restrictions. Note that in principle an intervention could make observationally impossible datatypes arise.
#' @param given Statement that evaluates to logical. Data conditional on specific values.
#' @export
#' @examples
