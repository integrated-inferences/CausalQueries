...
#' @param node An optional quoted name of the variable whose outcome should be revealed. If specified all values of parents need to be specified via \code{dos}.
#' @return A data.frame object of revealed data for each nodel (columns) given causal / nodal type (rows) .
#' @export
#' @examples
...
reveal_outcomes <- function(model, dos = NULL, node = NULL){
	...
	# Magic: Work though each endogeneous variable in sequence and substitute its implied values
