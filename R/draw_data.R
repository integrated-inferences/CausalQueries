...
#' Draw lambda
#'
#'  Draw a lambda vector given model priors.
#'
...
#' @param posterior A logical scalar. If \code{TRUE}, uses a posterior distribution. By default, set to \code{FALSE}, uses prior distributions.
...
#' @param w A vector of event probabilities.
...
#' @param lambda A numeric vector. Values of lambda may be specified. By default, it is drawn from priors.
...
#' @export
#' @examples
#' # A strategy in which X, Y aer observed for sure and M is observed
