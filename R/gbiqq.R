...
#' @export
#'
gbiqq <- function(dag, data, lambdas_prior = NULL,  P = NULL, ...) {
...
stan_data    <- make_gbiqq_data(dag = dag, data = data, lambdas_prior = lambdas_prior, P = P)

fitted_model <-	stan(model_code = simpler, data = stan_data,  ...)
