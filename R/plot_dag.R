...
#' @param nodecol String indicating color of node that is accepted by ggplot's default palette
...
plot_dag <- function(model = NULL,
  ...
  aes_list <- lapply(list(label = 'name'), function(i) dplyr::sym(i))
