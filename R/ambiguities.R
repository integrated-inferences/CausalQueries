...
#'
#' @details \code{reveal_outcomes} starts off by creating types (via \code{\link{gbiqq:::get_types}}). It then takes types of endogenous and reveals their outcome based on the value that their parents took. Exogenous variables outcomes correspond to their type.
#'
#' @param model A model created by \code{make_model}
