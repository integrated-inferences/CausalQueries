...
#' @return Objects from a \code{causal_model}, with summary.
#'
#' @export
#'
#' @examples
...
#'   }
#' @param ... Other arguments passed to helper \code{"get_*"} functions.
#' @return Quiet return of objects from a \code{causal_model}.
#'
#' @export
#'
#' @examples
