...
#' @param type An element of ("flat", "new", prior_mean", "posterior_mean", "prior_draw", "posterior_draw"). Indicates type of parameters to set.
#' @export
#' @examples
#' model <- set_parameters(make_model("X -> Y"),
#'           type = "flat")
#' # Use make_alpha to define specific parameters
#' model <- set_parameters(make_model("X -> Y"), type = "new",
