...
#'
#' @param model A model object generated by make_model().
#' @param lambda_priors A numeric vector. Dirichlet hyperparameters.
#' @param prior_distribution A character vector. Indicates the prior distribution to be used. Can be 'uniform', 'jeffreys', or 'certainty'.
#' @param alphas A numeric vector. Hyperparameters of the Dirichlet distribution to be passed to \code{make_priors()}.
#'
#' @export
...
#'
#' Add a vector of true parameters --- can be used to draw data, rather than true vector.
#'
#' @param model A model generated by \code{make_model}.
#' @param lambda A numeric vector. Lambdas to add to model.
#' @param random A logical scalar. If \code{TRUE}, random truth drawn from priors. Defaults to \code{FALSE}.
#' @param average  A logical scalar. If \code{TRUE}, prior mean used for parameter estimation.
#' @export
#' @examples
