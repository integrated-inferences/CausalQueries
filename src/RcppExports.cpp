...
RcppExport SEXP _rcpp_module_boot_stan_fit4simplexes_retain_w_mod();

static const R_CallMethodDef CallEntries[] = {
    {"_rcpp_module_boot_stan_fit4simplexes_mod", (DL_FUNC) &_rcpp_module_boot_stan_fit4simplexes_mod, 0},
    {"_rcpp_module_boot_stan_fit4simplexes_retain_w_mod", (DL_FUNC) &_rcpp_module_boot_stan_fit4simplexes_retain_w_mod, 0},
    {NULL, NULL, 0}
};
