...
#include "stanExports_simplexes_retain_w.h"

RCPP_MODULE(stan_fit4simplexes_retain_w_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_simplexes_retain_w")
