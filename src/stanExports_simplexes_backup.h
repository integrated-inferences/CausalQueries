...
namespace model_simplexes_backup_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_simplexes_backup");
    reader.add_event(71, 69, "end", "model_simplexes_backup");
    return reader;
}
#include <stan_meta_header.hpp>
class model_simplexes_backup : public prob_grad {
private:
        int n_vars;
        int n_nodal_types;
        int n_types;
        std::vector<int> n_types_each;
        int n_data;
        int n_events;
        int n_strategies;
        ...
        std::vector<vector_d> inverted_P;
        matrix_d A;
        matrix_d A_w;
        std::vector<int> Y;
public:
    model_simplexes_backup(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_simplexes_backup_namespace::model_simplexes_backup";
        ...
        try {
            ...
            check_greater_or_equal(function__, "n_vars", n_vars, 1);
            current_statement_begin__ = 4;
            context__.validate_dims("data initialization", "n_nodal_types", "int", context__.to_vec());
            n_nodal_types = int(0);
            vals_i__ = context__.vals_i("n_nodal_types");
            pos__ = 0;
            n_nodal_types = vals_i__[pos__++];
            check_greater_or_equal(function__, "n_nodal_types", n_nodal_types, 1);
            ...
            validate_non_negative_index("n_types_each", "n_vars", n_vars);
            context__.validate_dims("data initialization", "n_types_each", "int", context__.to_vec(n_vars));
            n_types_each = std::vector<int>(n_vars, int(0));
            vals_i__ = context__.vals_i("n_types_each");
            pos__ = 0;
            size_t n_types_each_k_0_max__ = n_vars;
            for (size_t k_0__ = 0; k_0__ < n_types_each_k_0_max__; ++k_0__) {
                n_types_each[k_0__] = vals_i__[pos__++];
            }
            size_t n_types_each_i_0_max__ = n_vars;
            for (size_t i_0__ = 0; i_0__ < n_types_each_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "n_types_each[i_0__]", n_types_each[i_0__], 1);
            }
            ...
            validate_non_negative_index("lambdas_prior", "n_nodal_types", n_nodal_types);
            context__.validate_dims("data initialization", "lambdas_prior", "vector_d", context__.to_vec(n_nodal_types));
            lambdas_prior = Eigen::Matrix<double, Eigen::Dynamic, 1>(n_nodal_types);
            vals_r__ = context__.vals_r("lambdas_prior");
            pos__ = 0;
            size_t lambdas_prior_j_1_max__ = n_nodal_types;
            ...
            validate_non_negative_index("l_starts", "n_vars", n_vars);
            context__.validate_dims("data initialization", "l_starts", "int", context__.to_vec(n_vars));
            l_starts = std::vector<int>(n_vars, int(0));
            vals_i__ = context__.vals_i("l_starts");
            pos__ = 0;
            size_t l_starts_k_0_max__ = n_vars;
            for (size_t k_0__ = 0; k_0__ < l_starts_k_0_max__; ++k_0__) {
                l_starts[k_0__] = vals_i__[pos__++];
            }
            size_t l_starts_i_0_max__ = n_vars;
            for (size_t i_0__ = 0; i_0__ < l_starts_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "l_starts[i_0__]", l_starts[i_0__], 1);
            }
            current_statement_begin__ = 13;
            validate_non_negative_index("l_ends", "n_vars", n_vars);
            context__.validate_dims("data initialization", "l_ends", "int", context__.to_vec(n_vars));
            l_ends = std::vector<int>(n_vars, int(0));
            vals_i__ = context__.vals_i("l_ends");
            pos__ = 0;
            size_t l_ends_k_0_max__ = n_vars;
            for (size_t k_0__ = 0; k_0__ < l_ends_k_0_max__; ++k_0__) {
                l_ends[k_0__] = vals_i__[pos__++];
            }
            size_t l_ends_i_0_max__ = n_vars;
            ...
            validate_non_negative_index("P", "n_nodal_types", n_nodal_types);
            context__.validate_dims("data initialization", "P", "vector_d", context__.to_vec(n_nodal_types,n_types));
            P = std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> >(n_nodal_types, Eigen::Matrix<double, Eigen::Dynamic, 1>(n_types));
            vals_r__ = context__.vals_r("P");
            pos__ = 0;
            size_t P_j_1_max__ = n_types;
            size_t P_k_0_max__ = n_nodal_types;
            ...
            validate_non_negative_index("inverted_P", "n_nodal_types", n_nodal_types);
            context__.validate_dims("data initialization", "inverted_P", "vector_d", context__.to_vec(n_nodal_types,n_types));
            inverted_P = std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> >(n_nodal_types, Eigen::Matrix<double, Eigen::Dynamic, 1>(n_types));
            vals_r__ = context__.vals_r("inverted_P");
            pos__ = 0;
            size_t inverted_P_j_1_max__ = n_types;
            size_t inverted_P_k_0_max__ = n_nodal_types;
            for (size_t j_1__ = 0; j_1__ < inverted_P_j_1_max__; ++j_1__) {
                for (size_t k_0__ = 0; k_0__ < inverted_P_k_0_max__; ++k_0__) {
                    inverted_P[k_0__](j_1__) = vals_r__[pos__++];
                }
            }
            current_statement_begin__ = 19;
            validate_non_negative_index("A", "n_data", n_data);
            validate_non_negative_index("A", "n_types", n_types);
            context__.validate_dims("data initialization", "A", "matrix_d", context__.to_vec(n_data,n_types));
            A = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(n_data, n_types);
            vals_r__ = context__.vals_r("A");
            pos__ = 0;
            size_t A_j_2_max__ = n_types;
            size_t A_j_1_max__ = n_data;
            ...
            A_w = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(n_events, n_data);
            vals_r__ = context__.vals_r("A_w");
            pos__ = 0;
            size_t A_w_j_2_max__ = n_data;
            size_t A_w_j_1_max__ = n_events;
            for (size_t j_2__ = 0; j_2__ < A_w_j_2_max__; ++j_2__) {
                for (size_t j_1__ = 0; j_1__ < A_w_j_1_max__; ++j_1__) {
                    A_w(j_1__, j_2__) = vals_r__[pos__++];
                }
            }
            ...
            validate_non_negative_index("gamma", "(n_nodal_types - n_vars)", (n_nodal_types - n_vars));
            num_params_r__ += (n_nodal_types - n_vars);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("gamma", "(n_nodal_types - n_vars)", (n_nodal_types - n_vars));
        context__.validate_dims("parameter initialization", "gamma", "vector_d", context__.to_vec((n_nodal_types - n_vars)));
        Eigen::Matrix<double, Eigen::Dynamic, 1> gamma((n_nodal_types - n_vars));
        size_t gamma_j_1_max__ = (n_nodal_types - n_vars);
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                gamma = in__.vector_lb_constrain(0, (n_nodal_types - n_vars), lp__);
            else
                gamma = in__.vector_lb_constrain(0, (n_nodal_types - n_vars));
            // transformed parameters
            current_statement_begin__ = 30;
            validate_non_negative_index("lambdas", "n_nodal_types", n_nodal_types);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> lambdas(n_nodal_types);
            stan::math::initialize(lambdas, DUMMY_VAR__);
            stan::math::fill(lambdas, DUMMY_VAR__);
            current_statement_begin__ = 31;
            validate_non_negative_index("sum_gammas", "n_vars", n_vars);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> sum_gammas(n_vars);
            ...
            (void) function__;  // dummy to suppress unused var warning
            current_statement_begin__ = 30;
            size_t lambdas_j_1_max__ = n_nodal_types;
            ...
            current_statement_begin__ = 31;
            size_t sum_gammas_j_1_max__ = n_vars;
            ...
            validate_non_negative_index("P_lambdas", "n_nodal_types", n_nodal_types);
            validate_non_negative_index("P_lambdas", "n_types", n_types);
            std::vector<Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1>  > P_lambdas(n_types, Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1>(n_nodal_types));
            stan::math::initialize(P_lambdas, DUMMY_VAR__);
            stan::math::fill(P_lambdas, DUMMY_VAR__);
            current_statement_begin__ = 49;
            for (int i = 1; i <= n_types; ++i) {
                current_statement_begin__ = 50;
                for (int j = 1; j <= n_nodal_types; ++j) {
            ...
            for (int i = 1; i <= n_vars; ++i) {
                ...
                lp_accum__.add((-(get_base1(n_types_each, i, "n_types_each", 1)) * stan::math::log(get_base1(sum_gammas, i, "sum_gammas", 1))));
            }
    ...
    void get_dims(std::vector<std::vector<size_t> >& dimss__) const {
        ...
        dims__.resize(0);
        dims__.push_back((n_nodal_types - n_vars));
        dimss__.push_back(dims__);
        dims__.resize(0);
        dims__.push_back(n_nodal_types);
        dimss__.push_back(dims__);
        dims__.resize(0);
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_simplexes_backup_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        Eigen::Matrix<double, Eigen::Dynamic, 1> gamma = in__.vector_lb_constrain(0, (n_nodal_types - n_vars));
        size_t gamma_j_1_max__ = (n_nodal_types - n_vars);
        for (size_t j_1__ = 0; j_1__ < gamma_j_1_max__; ++j_1__) {
        ...
        try {
            ...
            current_statement_begin__ = 30;
            validate_non_negative_index("lambdas", "n_nodal_types", n_nodal_types);
            Eigen::Matrix<double, Eigen::Dynamic, 1> lambdas(n_nodal_types);
            stan::math::initialize(lambdas, DUMMY_VAR__);
            stan::math::fill(lambdas, DUMMY_VAR__);
            current_statement_begin__ = 31;
            validate_non_negative_index("sum_gammas", "n_vars", n_vars);
            Eigen::Matrix<double, Eigen::Dynamic, 1> sum_gammas(n_vars);
            stan::math::initialize(sum_gammas, DUMMY_VAR__);
            stan::math::fill(sum_gammas, DUMMY_VAR__);
...
typedef model_simplexes_backup_namespace::model_simplexes_backup stan_model;
#endif
