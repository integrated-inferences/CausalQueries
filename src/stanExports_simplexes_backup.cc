...
#include "stanExports_simplexes_backup.h"

RCPP_MODULE(stan_fit4simplexes_backup_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_simplexes_backup")
