...
testthat::test_that(desc = "Check disallow redundant arguments",
...
testthat::skip_on_cran()
testthat::test_that(desc = "Check non existent column and parameter name errors",
...
testthat::skip_on_cran()
testthat::test_that(desc = "Check output",
